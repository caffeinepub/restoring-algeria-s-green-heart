...
export class Backend implements backendInterface {
    ...
    async adoptTree(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adoptTree(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async createEvent(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getUserEvents(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserEvents();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async signUpForEvent(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.signUpForEvent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
